...
def extract_answers_from_pdf(pdf_path):
    ...
    # Use regex to find answer patterns, this can vary based on PDF structure
    # Assuming the answer key is structured like: "1 D", "2 A", etc.
    answers = {}
...
if __name__ == "__main__":
    pdf_path = "./5054_s19_ms_11.pdf"
    json_path = "./5054_s19_qp_11.json"
